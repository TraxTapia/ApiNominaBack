...
namespace Api.Models.Nomina.Service
{
    public class ServiceCall<T>
    {
        //PUT o POST
        //public static async Task<OperationResult<T>> CallServiceAsync<T2>(T2 Params, String apiUrl, String accion, String tipoLlamado)
        //{
