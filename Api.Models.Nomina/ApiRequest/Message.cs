...
namespace Api.Models.Nomina.ApiRequest
{
    public class Message
    {
        ...
        public T SendRequest<T>(string EndPointUrl,  string Action, string Payload, HttpMethod Method)
        {
            ...
            return JsonSerializerData.Deserialize<T>(_Response);
        }
        ...
        //}
        //public  async Task<T> LLamarServicioPostGeneral<T2>(string EndPointUrl, string Action, T2 Payload, HttpMethod Method)
        //{
        //    try
        //    {
        //        Uri requestUrl = CreateRequestUri(EndPointUrl, string.Format(System.Globalization.CultureInfo.InvariantCulture, Action));
        ...
        //            HttpResponseMessage Res = await client.PostAsync(requestUrl.ToString(), CreateHttpContent<T2>(Payload));
